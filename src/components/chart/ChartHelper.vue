    ...
    g.helper-group
      g.chart-helper
        ...
        svg(:x='x1-75' :y='yBudge' style='overflow:visible')
          ...
          text.helper-price(x='75' y='18' text-anchor="middle") {{currency.replace(/\w/i,i=>i.toUpperCase()) + ' Price: ' + helper.price}}     
          text.helper-date(x='75' y='33' text-anchor="middle") {{helper.date}}
